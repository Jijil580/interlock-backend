...
const DailyReportSchema = new mongoose.Schema({
  workerPayments: [{ workerName: String, amount: Number, date: String, note: String }],workerPayments: [{ workerName: String, amount: Number, date: String, note: String }],  date: String,
  newSite: String,
  runningSite: String,
